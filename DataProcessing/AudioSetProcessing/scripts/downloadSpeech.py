"""
PLEASE READ:
This code is taken from the GitHub repository "https://github.com/aoifemcdonagh/audioset-processing".
All credit for this code goes to the original author, Aoife McDonagh.
The code is free for use and modification under the MIT License.
Thanks to Aoife!
"""
...
def download(class_name, args,  max_downloads=None):
